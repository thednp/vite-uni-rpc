...
var _chunkCOJZFXGEcjs = require('./chunk-COJZFXGE.cjs');
...
var defineConfig = (uniConfig) => {
  return _vite.mergeConfig.call(void 0, _chunkHEGFZJIOcjs.defaultRPCOptions, uniConfig);
};
var RPCConfig;
  ...
  try {
    ...
    if (configFile) {
      ...
      if (!_fs.existsSync.call(void 0, configFilePath)) {
        ...
        RPCConfig = _chunkHEGFZJIOcjs.defaultRPCOptions;
        return _chunkHEGFZJIOcjs.defaultRPCOptions;
      }
      ...
      if (result) {
        ...
        RPCConfig = _vite.mergeConfig.call(void 0, 
          {
            ..._chunkHEGFZJIOcjs.defaultRPCOptions,
...
async function rpcPlugin(devOptions = {}) {
  ...
  return {
    ...
    async buildStart() {
      await _chunkHEGFZJIOcjs.scanForServerFiles.call(void 0, config, viteServer);
    },
    async transform(code, id, ops) {
      ...
      const result = await _vite.transformWithEsbuild.call(void 0, _chunkHEGFZJIOcjs.getClientModules.call(void 0, options), id, {
        loader: "js",
        target: "es2020"
      });
      return {
    ...
    configureServer(server) {
      ...
      server.middlewares.use(
        _chunkCOJZFXGEcjs.createRPCMiddleware.call(void 0, rest)
      );
    }
  };
}
