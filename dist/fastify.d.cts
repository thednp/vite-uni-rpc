import { F as FastifyMiddlewareFn, B as BodyResult } from './types.d-BTEF26oe.cjs';
export { f as FastifyMiddlewareHooks, e as FastifyMiddlewareOptions, g as RpcFastifyPluginOptions } from './types.d-BTEF26oe.cjs';
