import { A as Arguments, S as ServerFnEntry, a as ServerFunctionOptions, C as CSRFMiddlewareOptions, M as MiddlewareOptions, b as CSRFTokenOptions } from './types.d-C4EV56Ih.cjs';
...
declare const createMiddleware: (initialOptions?: Partial<MiddlewareOptions>) => (req: IncomingMessage | Request, res: ServerResponse<IncomingMessage>, next: Connect.NextFunction) => Promise<unknown>;
declare const createRPCMiddleware: (initialOptions?: Partial<MiddlewareOptions>) => (req: IncomingMessage | Request, res: ServerResponse<IncomingMessage>, next: Connect.NextFunction) => Promise<unknown>;
...
declare const rpcMiddleware: (req: http.IncomingMessage | express.Request, res: http.ServerResponse<http.IncomingMessage>, next: vite.Connect.NextFunction) => Promise<unknown>;
