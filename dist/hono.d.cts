import { H as HonoMiddlewareFn, B as BodyResult } from './types.d-DSKMH2Du.cjs';
export { k as HonoMiddlewareHooks, l as HonoMiddlewareOptions } from './types.d-DSKMH2Du.cjs';
